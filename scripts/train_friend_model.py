...
Usage:
    conda run -n ai_env python scripts/train_friend_model.py --csv data/rule_based_20260628_203648.csv
"""
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="external_models/friend_model", help="Output directory for model")
